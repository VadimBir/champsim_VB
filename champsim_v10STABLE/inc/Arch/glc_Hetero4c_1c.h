...
// ARCHITECTURE OF glc (ALDER LAKE) 

#ifndef CHAMPSIM_DEFS_H
#define CHAMPSIM_DEFS_H


// 4cHetero via single core sim
// FOR 4cHetero, NUM_CPUS = 1 BUT everywhere where the NUM_CORES mult the result has to be changed into x4 
// THUS RUN 1 core with x4 resources
...
// LAST LEVEL CACHE
#define LLC_SET 4*4096 // 3MB per core
#define LLC_WAY 12
#define LLC_RQ_SIZE 4*L2C_MSHR_SIZE //48
#define LLC_WQ_SIZE 4*L2C_MSHR_SIZE //48
#define LLC_PQ_SIZE 4*32
#define LLC_MSHR_SIZE 4*64
/*
