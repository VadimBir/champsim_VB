...
inline bool llc_bypass_operate(int cpu, CACHE *L1D, CACHE *L2C, CACHE *LLC) {
    ...
    double apc_l1d  = lpm[cpu][L2C_type].apc_accessesDivActiveMemCy_ratio;
    ...
    double immediate =
          (double)LLC->RQ.occupancy * camat
        + (double)LLC->PQ.occupancy * camat;
